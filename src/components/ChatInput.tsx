  ...
  return (
    <div className='p-4 bg-gray-50 dark:bg-[#1B1C1D] pb-10'>
      <form onSubmit={handleSubmit} className='max-w-3xl mx-auto flex items-center space-x-3'>
        ...
        <button
          type='submit'
          className='px-4 py-2 bg-blue-600 text-white font-medium rounded-xl hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 transition duration-150 ease-in-out'
